        ...
        <main className="flex-1 max-w-7xl mx-auto px-6 py-12 md:px-12">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
              ...
              <div className="text-center lg:text-left flex-1 max-w-2xl">
                ...
                <p className="text-lg md:text-xl lg:text-2xl text-slate-300 mb-8 leading-relaxed">
                  ...
                  digital experiences through clean code and collaborative
                  innovation.
                </p>
                ...
                <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                  <Link
                    href="#contact"
                    className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3 rounded-full font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-center"
                  >
                    Get In Touch
                  </Link>
                  <Link
                    href="#skills"
                    className="border border-slate-600 hover:border-blue-400 text-slate-300 hover:text-blue-400 px-8 py-3 rounded-full font-semibold transition-all duration-200 hover:bg-slate-800/50 text-center"
                  >
                    Explore Skills
                  </Link>
                </div>
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-slate-200 to-slate-400 bg-clip-text text-transparent">
                About Me
              </h2>
              ...
              <div className="space-y-6">
                <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl">
                  <p className="text-slate-300 leading-relaxed">
                    ...
                    successful projects that demonstrate my strong capacity for
                    team collaboration and self-motivation. My{" "}
                    <span className="text-blue-400 font-semibold">
                      JavaScript/TypeScript
                    </span>{" "}
                    is the sharpest skill in my toolbox, whether in browser,
                    Node.js or React Native environments.
                  </p>
                </div>

                <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl">
                  <p className="text-slate-300 leading-relaxed">
                    Beyond this, I&apos;ve made contributions to projects across
                    a diverse range of technologies like{" "}
                    <span className="text-purple-400 font-semibold">
                      Python, Kotlin, C# and Scala
                    </span>
                    . Currently, I&apos;m diving deep into{" "}
                    <span className="text-green-400 font-semibold">
                      Fastify, BullMQ, Redis, Postgres, Odoo and Cloud
                    </span>
                    .
                  </p>
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl">
                  <p className="text-slate-300 leading-relaxed">
                    ...
                    it&apos;s a fulfilling journey that encompasses{" "}
                    <span className="text-blue-400 font-semibold">
                      creativity, collaboration, technical prowess, and
                      adaptability
                    </span>
                    . It offers a platform to connect with users, influence
                    businesses, and make a meaningful impact on people&apos;s
                    lives.
                  </p>
                </div>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl">
                  <p className="text-slate-300 leading-relaxed">
                    ...
                    with my beautiful partner and son. I&apos;m{" "}
                    {new Date().getFullYear() - 1991} years old and enjoy board
            ...
            <div className="mt-12 bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-600/50 shadow-xl">
              <div className="text-center">
                ...
                <p className="text-slate-300 leading-relaxed italic max-w-4xl mx-auto">
                  An ENFJ exhibits traits of extroversion, intuition, and
                  empathy, reflected in their collaborative and compassionate
                  workplace approach. Dedicated to fostering positive
                  relationships and driven by strong ethics, they harness
                  creativity to realize ambitions, making them influential and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="group bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:border-blue-500/50">
                ...
                <p className="text-slate-400 leading-relaxed">
                  High-quality and responsive web application development with
              ...
              <div className="group bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:border-purple-500/50">
                ...
                <p className="text-slate-400 leading-relaxed">
                  ...
                  development with robust architecture.
                </p>
              </div>
              ...
              <div className="group bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:border-green-500/50">
                ...
                <p className="text-slate-400 leading-relaxed">
                  Professional development of cross-platform applications for
              ...
              <div className="group bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:border-orange-500/50">
                ...
                <p className="text-slate-400 leading-relaxed">
                  Leading teams towards success, mentoring developers, and
                  fostering collaborative growth environments.
                </p>
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              <div className="group bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/50 relative">
                <div className="absolute top-6 right-6 text-blue-400/20 text-6xl font-serif">
                  &ldquo;
                </div>
                <blockquote className="text-slate-300 leading-relaxed text-lg relative z-10">
                  Jordan is a highly technically skilled and curious person. On
                  top of that he has a great deal of empathy and the ability to
                  assess from perspectives other than his own. He has shown
                  great self awareness in the time that I&apos;ve known him and
                  a constant drive for meaning and purpose. He will challenge
                  the status quo to cultivate the best possible environment for
                  him and those around him. I believe Jordan will excel in any
                  Engineering role especially if he gets to interface with /
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-slate-400 text-sm">
                        Software Engineer at Kurtosys Systems
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="group bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:border-purple-500/50 relative">
                <div className="absolute top-6 right-6 text-purple-400/20 text-6xl font-serif">
                  &ldquo;
                </div>
                <blockquote className="text-slate-300 leading-relaxed text-lg relative z-10">
                  Jordan has a vibrant positive can-do attitude to tackling all
                  tasks and obstacles presented to him and is a great team
                  member with his technical knowhow and his team comradery. It
                  was a great pleasure managing and working with Jordan through
                  various projects.
                </blockquote>
                <div className="mt-6 pt-6 border-t border-slate-700/50">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-slate-400 text-sm">
                        Engineering Lead at Global Logistics Internet
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <footer className="bg-slate-900/50 backdrop-blur-sm border-t border-slate-800/50 py-12">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center">
              ...
              <div className="text-slate-400 text-sm">
                <p className="mb-2">
                  © {new Date().getFullYear()} Jordan Cole Hunt. All rights
                  reserved.
                </p>
