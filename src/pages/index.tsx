      ...
      <main className="flex-1 px-6 py-12 md:px-12 lg:px-24">
        <section className="mb-12" id="about">
          ...
          <p className="text-gray-300 leading-relaxed pt-5 italic">
            ...
            approach to the workplace and interactions with colleagues. Renowned
            for their collaborative and compassionate nature, they are dedicated
            to fostering positive relationships and are driven by a strong set
            of ethics and values. Their ability to harness creativity to realize
            their ambitions makes them influential and inspirational team
            members.
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            <div className="bg-gray-800 p-4 rounded-md">
              <blockquote className="text-gray-300 italic">
                ...
                especially if he gets to interface with / manage other
                engineers.&quot;
              </blockquote>
            ...
            <div className="bg-gray-800 p-4 rounded-md">
              <blockquote className="text-gray-300 italic">
                &quot;Jordan has a vibrant positive can-do attitude to tackling
                all tasks and obstacles presented to him and is a great team
                member with his technical knowhow and his team comradery. It was
                a great pleasure managing and working with Jordan through
                various projects.&quot;
              </blockquote>
              <div className="mt-4 text-gray-400">
                - Craig Naylor - Engineering Lead at Global Logistics Internet.
              </div>
            </div>
          </div>
        </section>
